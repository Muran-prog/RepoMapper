...
export const PARAM_INFO = Object.freeze({
  ...
  roadsOrangeBold: {
    ...
    keywords: ['дороги', 'трассы', 'магистрали', 'roads', 'жирные', 'оранжевые', 'highway', 'шоссе', 'выделенные'],
  },
  settlementOutline: {
    title: 'Контуры населённых пунктов',
    ...
    keywords: ['поселения', 'города', 'сёла', 'границы', 'обводка', 'рамка', 'контуры', 'settlements', 'outline'],
  },
  ...
  swampCover: {
    title: 'Болота и топи',
    body: 'Классифицирует водно-болотные угодья по проходимости и красит каждую категорию своим оттенком оранжевого: от светло-золотистых влажных лугов (легко пройти) через марши, тростники и лесные болота до тёмно-кирпичных топей и илистых отмелей (непроходимо). Отдельными оттенками показаны соляные пруды и болота без указанного типа. Данные — OpenStreetMap (natural=wetland + wetland=*). Это дополнительный слой поверх рельефа — тени и 3D не выключаются.',
    keywords: ['болото', 'болота', 'топи', 'трясина', 'марш', 'тростник', 'низинное', 'верховое', 'солончак', 'проходимость', 'водно-болотные угодья', 'wetland', 'swamp', 'marsh', 'bog', 'fen', 'reedbed', 'saltmarsh', 'оранжевый'],
  },
  forestCities: {
    title: 'Города — жирным',
